...
expr:
  ...
  | VAR; LPAREN; e=expr; RPAREN { Call($1,e)}
...
decl: 
  | { EmptyDecl }
  | INT; VAR; { IntVar($2) }
  | FUN; VAR; LPAREN; VAR; RPAREN; LBRACE; c=cmd; SM; RET; e=expr; RBRACE;  { Fun($2,$4,c,e) }
  | d1=decl; SM; d2=decl { DSeq(d1,d2) }
;
